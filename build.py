...
CARDS = {c: _cards(c) for c in ("chiro", "elektrisch", "hydraulisch", "fix", "stuehle", "sichtschutz", "mrt", "wagen", "station", "gvw", "btisch")}
...
_ST_LEAD = "Ausstattung für Bettenstation und Ambulanz: Nachtkästchen, Bettbeistelltische, Infusionsständer, Auftritte und Injektionsstühle – überwiegend aus Edelstahl 0H18N9 oder pulverbeschichtetem Stahl, fahrbar und auf tägliche Wischdesinfektion ausgelegt."
...
_PUI = {
 "en": {
  ...
  "Ausstattung für Bettenstation und Ambulanz: Nachtkästchen, Bettbeistelltische, Infusionsständer, Auftritte und Injektionsstühle – überwiegend aus Edelstahl 0H18N9 oder pulverbeschichtetem Stahl, fahrbar und auf tägliche Wischdesinfektion ausgelegt.": "Equipment for inpatient wards and outpatient clinics: bedside cabinets, overbed tables, IV pole stands, foot stools and injection chairs – mostly in stainless steel 0H18N9 or powder-coated steel, mobile and designed for daily wipe disinfection.",
 ...
 "pl": {
  ...
  "Ausstattung für Bettenstation und Ambulanz: Nachtkästchen, Bettbeistelltische, Infusionsständer, Auftritte und Injektionsstühle – überwiegend aus Edelstahl 0H18N9 oder pulverbeschichtetem Stahl, fahrbar und auf tägliche Wischdesinfektion ausgelegt.": "Wyposażenie oddziałów łóżkowych i ambulatoriów: szafki przyłóżkowe, stoliki przyłóżkowe, stojaki infuzyjne, podesty i fotele do iniekcji – głównie ze stali nierdzewnej 0H18N9 lub stali malowanej proszkowo, mobilne i przystosowane do codziennej dezynfekcji przez przecieranie.",
...
_PROD_CHROME = [
  ...
  "Einheitlich aufgebaut: 500 mm Korpustiefe, 1000 mm Arbeitshöhe, vertiefte Arbeitsplatte mit drei Aufkantungen und Ø 125 mm Rollen mit zwei Feststellern. Fronten und Griffe sind farbig nach TECH-MED-Farbkarte erhältlich – so lassen sich Stationen auf einen Blick unterscheiden. Das Zubehörprogramm ist über alle Baureihen hinweg identisch und frei kombinierbar.",
  "Materialausführungen: ABS = Stahlkorpus mit Arbeitsplatte aus ABS-Kunststoff · ST = Korpus und Arbeitsplatte aus pulverbeschichtetem Stahl · KO = Korpus und Arbeitsplatte aus Edelstahl 0H18N9 für die höchste Hygienestufe.",
  "Ausstattung für Bettenstation und Ambulanz: Nachtkästchen, Bettbeistelltische, Infusionsständer, Auftritte und Injektionsstühle – überwiegend aus Edelstahl 0H18N9 oder pulverbeschichtetem Stahl, fahrbar und auf tägliche Wischdesinfektion ausgelegt.",
...
def _body_produkte(lang):
    ...
    for c in ("fix", "hydraulisch", "elektrisch", "chiro", "stuehle", "sichtschutz", "mrt", "wagen", "station", "gvw", "btisch"):
