...
CARDS = {c: _cards(c) for c in ("chiro", "elektrisch", "hydraulisch", "fix", "stuehle", "sichtschutz", "mrt", "wagen", "station", "gvw")}
...
def _body_produkte(lang):
    ...
    for c in ("fix", "hydraulisch", "elektrisch", "chiro", "stuehle", "sichtschutz", "mrt", "wagen", "station", "gvw"):
